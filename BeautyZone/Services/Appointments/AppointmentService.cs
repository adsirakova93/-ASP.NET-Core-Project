...
using BeautyZone.Services.Appointments.Models.Enums;
using System;
using System.Collections.Generic;
using System.Globalization;
using System.Linq;

namespace BeautyZone.Services.Appointments
{
    public class AppointmentService : IAppointmentService
    {
        ...
        public AppointmentService(BeautyZoneDbContext data, IMapper mapper)
        {
            this.data = data;
            this.mapper = mapper;
        }
